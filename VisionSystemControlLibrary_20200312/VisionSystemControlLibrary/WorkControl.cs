...
namespace VisionSystemControlLibrary
{
    public partial class WorkControl : UserControl
    {
        ...
        private void _SetLanguage()
        {
            ...
            customButtonRejects.Language = language;//【REJECTS】
            ...
            {
                for (i = 0; i < system.Camera.Length; i++)//遍历相机
                {
        ...
        private void _SetDeviceState()
        {
            if (VisionSystemClassLibrary.Enum.DeviceState.Run == devicestate)//运行
            {
                ...
                if (VisionSystemClassLibrary.Enum.CameraType.None != system.Work.SelectedCameraType)//当前选择了某一相机显示控件
                {
                    ...
                    customButtonRejects.CustomButtonBackgroundImage = CustomButton_BackgroundImage.Up;//更新【REJECTS】按钮的背景
                ...
                else//当前未选择任何相机显示控件
                {
                    ...
                    customButtonRejects.CustomButtonBackgroundImage = CustomButton_BackgroundImage.Disable;//更新【REJECTS】按钮的背景
        ...
        private void _SetSystem()
        {
            ...
            if (null != system.Camera)
            {
                for (i = 0; i < system.Camera.Length; i++)
                {
        ...
        private void _SetDefault()
        {
            ...
            language = VisionSystemClassLibrary.Enum.InterfaceLanguage.English;//语言
            ...
            //FOCKE FX，1280 * 1024
            //↓↓
            system.Camera = new VisionSystemClassLibrary.Class.Camera[2];
            for (i = 0; i < system.Camera.Length; i++)
            {
                system.Camera[i] = new VisionSystemClassLibrary.Class.Camera();
            }

            system.UIParameter.Work_BackgroundImage_Zoom = new Boolean[1];
            system.UIParameter.Work_BackgroundImage_Location = new Point[1];

            system.UIParameter.Work_BackgroundImage_Zoom[0] = false;
            system.UIParameter.Work_BackgroundImage_Location[0] = new Point(130, 0);//
            system.UIParameter.Work_SpeedPhase_Value_Location = new Point(710, 420);//
            system.UIParameter.Work_SpeedPhase_Value_Size = new Size(60, 30);//
            system.UIParameter.Work_SpeedPhase_Value_FontSize = 15.75F;//
            system.UIParameter.Work_SpeedPhase_Unit_Location = new Point(770, 420);//
            system.UIParameter.Work_SpeedPhase_Unit_Size = new Size(60, 30);//
            system.UIParameter.Work_SpeedPhase_Unit_FontSize = 12F;//
            system.UIParameter.Work_TotalPage = 1;//
            system.Work.CurrentPage = 0;//
            system.Work.SelectedCameraType = VisionSystemClassLibrary.Enum.CameraType.None;//
            system.Work.SelectedCameraIndex = -1;//

            system.Camera[0].Type = VisionSystemClassLibrary.Enum.CameraType.Camera_1;//相机类型
            system.Camera[0].Name = "Top";//相机名称
            //
            system.Camera[0].UIParameter.SpeedPhase_Display = false;//
            system.Camera[0].UIParameter.SpeedPhase_AsMachine = true;//

            system.Camera[0].UIParameter.Work_Page = 0;//
            system.Camera[0].UIParameter.Work_LineStart_Location = new Point(410, 150);//
            system.Camera[0].UIParameter.Work_LineEnd_Location = new Point(660, 150);//
            system.Camera[0].UIParameter.Work_ImageDisplayBackground_Left = 5;//
            system.Camera[0].UIParameter.Work_ImageDisplayBackground_Top = 5;//
            system.Camera[0].UIParameter.Work_ImageDisplay_Location = new Point(670, 20);//
            system.Camera[0].UIParameter.Work_ImageDisplay_Size = new Size(372, 240);//
            system.Camera[0].UIParameter.Work_ImageDisplay_Message_FontSize = 7;//
            system.Camera[0].UIParameter.Work_ImageDisplay_Message_Location = new Point(5, 3);//
            system.Camera[0].UIParameter.Work_ImageDisplay_Message_Size = new Size(314, 12);//
            system.Camera[0].UIParameter.Work_ImageDisplay_Slot_Location = new Point(8, 15);//
            system.Camera[0].UIParameter.Work_ImageDisplay_Slot_Size = new Size(120, 6);//
            system.Camera[0].UIParameter.Work_ImageDisplay_MinValue_FontSize = 7;//
            system.Camera[0].UIParameter.Work_ImageDisplay_MinValue_Location = new Point(136, 12);//
            system.Camera[0].UIParameter.Work_ImageDisplay_MinValue_Size = new Size(63, 10);//
            system.Camera[0].UIParameter.Work_ImageDisplay_CurrentValue_FontSize = 7;//
            system.Camera[0].UIParameter.Work_ImageDisplay_CurrentValue_Location = new Point(205, 12);//
            system.Camera[0].UIParameter.Work_ImageDisplay_CurrentValue_Size = new Size(63, 10);//
            system.Camera[0].UIParameter.Work_ImageDisplay_MaxValue_FontSize = 7;//
            system.Camera[0].UIParameter.Work_ImageDisplay_MaxValue_Location = new Point(274, 12);//
            system.Camera[0].UIParameter.Work_ImageDisplay_MaxValue_Size = new Size(90, 10);//
            system.Camera[0].UIParameter.Work_ImageDisplay_Lamp_Location = new Point(343, 5);//
            system.Camera[0].UIParameter.Work_ImageDisplay_Lamp_Size = new Size(18, 16);//
            system.Camera[0].UIParameter.Work_Name_FontSize = 12;//
            system.Camera[0].UIParameter.Work_Name_Location = new Point(705, 265);//
            system.Camera[0].UIParameter.Work_Name_Size = new Size(302, 25);//
            system.Camera[0].UIParameter.Work_State_FontSize = 12;//
            system.Camera[0].UIParameter.Work_State_Location = new Point(705, 290);//
            system.Camera[0].UIParameter.Work_State_Size = new Size(302, 25);//
            system.Camera[0].UIParameter.Work_SpeedPhase_Value_FontSize = 12;//
            system.Camera[0].UIParameter.Work_SpeedPhase_Value_Location = new Point(705, 315);//
            system.Camera[0].UIParameter.Work_SpeedPhase_Value_Size = new Size(151, 25);//
            system.Camera[0].UIParameter.Work_SpeedPhase_Unit_FontSize = 12;//
            system.Camera[0].UIParameter.Work_SpeedPhase_Unit_Location = new Point(856, 315);//
            system.Camera[0].UIParameter.Work_SpeedPhase_Unit_Size = new Size(151, 25);//
            //
            system.Camera[0].Live.CameraSelected = false;//相机显示控件是否被选中。true：是；false：否
            //
            system.Camera[0].DeviceInformation.Connected = true;//是否与客户端建立了连接。取值范围：true，是；false，否
            system.Camera[0].DeviceInformation.GetDevInfo = true;//是否存储了客户端的设备信息。取值范围：true，是；false，否
            system.Camera[0].DeviceInformation.CAM = VisionSystemClassLibrary.Enum.CameraState.CONNECTED | VisionSystemClassLibrary.Enum.CameraState.ON;//相机状态

            system.Camera[1].Type = VisionSystemClassLibrary.Enum.CameraType.Camera_2;//相机类型
            system.Camera[1].Name = "Bottom";//相机名称
            //
            system.Camera[1].UIParameter.SpeedPhase_Display = false;//
            system.Camera[1].UIParameter.SpeedPhase_AsMachine = true;//

            system.Camera[1].UIParameter.Work_Page = 0;//
            system.Camera[1].UIParameter.Work_LineStart_Location = new Point(670, 565);//
            system.Camera[1].UIParameter.Work_LineEnd_Location = new Point(410, 565);//
            system.Camera[1].UIParameter.Work_ImageDisplayBackground_Left = 5;//
            system.Camera[1].UIParameter.Work_ImageDisplayBackground_Top = 5;//
            system.Camera[1].UIParameter.Work_ImageDisplay_Location = new Point(30, 460);//
            system.Camera[1].UIParameter.Work_ImageDisplay_Size = new Size(372, 240);//
            system.Camera[1].UIParameter.Work_ImageDisplay_Message_FontSize = 7;//
            system.Camera[1].UIParameter.Work_ImageDisplay_Message_Location = new Point(5, 3);//
            system.Camera[1].UIParameter.Work_ImageDisplay_Message_Size = new Size(314, 12);//
            system.Camera[1].UIParameter.Work_ImageDisplay_Slot_Location = new Point(8, 15);//
            system.Camera[1].UIParameter.Work_ImageDisplay_Slot_Size = new Size(120, 6);//
            system.Camera[1].UIParameter.Work_ImageDisplay_MinValue_FontSize = 7;//
            system.Camera[1].UIParameter.Work_ImageDisplay_MinValue_Location = new Point(136, 12);//
            system.Camera[1].UIParameter.Work_ImageDisplay_MinValue_Size = new Size(63, 9);//
            system.Camera[1].UIParameter.Work_ImageDisplay_CurrentValue_FontSize = 7;//
            system.Camera[1].UIParameter.Work_ImageDisplay_CurrentValue_Location = new Point(205, 12);//
            system.Camera[1].UIParameter.Work_ImageDisplay_CurrentValue_Size = new Size(63, 9);//
            system.Camera[1].UIParameter.Work_ImageDisplay_MaxValue_FontSize = 7;//
            system.Camera[1].UIParameter.Work_ImageDisplay_MaxValue_Location = new Point(274, 12);//
            system.Camera[1].UIParameter.Work_ImageDisplay_MaxValue_Size = new Size(90, 9);//
            system.Camera[1].UIParameter.Work_ImageDisplay_Lamp_Location = new Point(343, 5);//
            system.Camera[1].UIParameter.Work_ImageDisplay_Lamp_Size = new Size(18, 16);//
            system.Camera[1].UIParameter.Work_Name_FontSize = 12;//
            system.Camera[1].UIParameter.Work_Name_Location = new Point(65, 705);//
            system.Camera[1].UIParameter.Work_Name_Size = new Size(302, 25);//
            system.Camera[1].UIParameter.Work_State_FontSize = 12;//
            system.Camera[1].UIParameter.Work_State_Location = new Point(65, 730);//
            system.Camera[1].UIParameter.Work_State_Size = new Size(302, 25);//
            system.Camera[1].UIParameter.Work_SpeedPhase_Value_FontSize = 12;//
            system.Camera[1].UIParameter.Work_SpeedPhase_Value_Location = new Point(65, 755);//
            system.Camera[1].UIParameter.Work_SpeedPhase_Value_Size = new Size(151, 25);//
            system.Camera[1].UIParameter.Work_SpeedPhase_Unit_FontSize = 12;//
            system.Camera[1].UIParameter.Work_SpeedPhase_Unit_Location = new Point(216, 755);//
            system.Camera[1].UIParameter.Work_SpeedPhase_Unit_Size = new Size(151, 25);//
            //
            system.Camera[1].Live.CameraSelected = false;//相机显示控件是否被选中。true：是；false：否
            //
            system.Camera[1].DeviceInformation.Connected = true;//是否与客户端建立了连接。取值范围：true，是；false，否
            system.Camera[1].DeviceInformation.GetDevInfo = true;//是否存储了客户端的设备信息。取值范围：true，是；false，否
            system.Camera[1].DeviceInformation.CAM = VisionSystemClassLibrary.Enum.CameraState.CONNECTED | VisionSystemClassLibrary.Enum.CameraState.ON;//相机状态
            //↑↑
            //FOCKE FX，1280 * 1024

            //COMMON、G.DX6S，1024 * 768
            //↓↓
            system.Camera = new VisionSystemClassLibrary.Class.Camera[3];
            for (i = 0; i < system.Camera.Length; i++)
            {
                system.Camera[i] = new VisionSystemClassLibrary.Class.Camera();
            }
            ...
            system.UIParameter.Work_BackgroundImage_Zoom[0] = false;//
            system.UIParameter.Work_BackgroundImage_Location[0] = new Point(157, 10);//
            system.UIParameter.Work_SpeedPhase_Value_Location = new Point(370, 400);//
            system.UIParameter.Work_SpeedPhase_Value_Size = new Size(60, 30);//
            system.UIParameter.Work_SpeedPhase_Value_FontSize = 15.75F;//
            system.UIParameter.Work_SpeedPhase_Unit_Location = new Point(430, 400);//
            system.UIParameter.Work_SpeedPhase_Unit_Size = new Size(60, 30);//
            system.UIParameter.Work_SpeedPhase_Unit_FontSize = 12F;//
            system.UIParameter.Work_TotalPage = 1;//
            system.Work.CurrentPage = 0;//
            ...
            system.Camera[0].UIParameter.Work_Page = 0;//
            system.Camera[0].UIParameter.Work_LineStart_Location = new Point(423, 60);//
            system.Camera[0].UIParameter.Work_LineEnd_Location = new Point(580, 60);//
            system.Camera[0].UIParameter.Work_ImageDisplayBackground_Left = 5;//
            system.Camera[0].UIParameter.Work_ImageDisplayBackground_Top = 5;//
            system.Camera[0].UIParameter.Work_ImageDisplay_Location = new Point(590, 10);//
            system.Camera[0].UIParameter.Work_ImageDisplay_Size = new Size(192, 144);//
            system.Camera[0].UIParameter.Work_ImageDisplay_Message_FontSize = 3;//
            system.Camera[0].UIParameter.Work_ImageDisplay_Message_Location = new Point(3, 3);//
            system.Camera[0].UIParameter.Work_ImageDisplay_Message_Size = new Size(162, 6);//
            system.Camera[0].UIParameter.Work_ImageDisplay_Slot_Location = new Point(4, 9);//
            system.Camera[0].UIParameter.Work_ImageDisplay_Slot_Size = new Size(60, 3);//
            system.Camera[0].UIParameter.Work_ImageDisplay_MinValue_FontSize = 3;//
            system.Camera[0].UIParameter.Work_ImageDisplay_MinValue_Location = new Point(70, 8);//
            system.Camera[0].UIParameter.Work_ImageDisplay_MinValue_Size = new Size(32, 4);//
            system.Camera[0].UIParameter.Work_ImageDisplay_CurrentValue_FontSize = 3;//
            system.Camera[0].UIParameter.Work_ImageDisplay_CurrentValue_Location = new Point(106, 8);//
            system.Camera[0].UIParameter.Work_ImageDisplay_CurrentValue_Size = new Size(32, 4);//
            system.Camera[0].UIParameter.Work_ImageDisplay_MaxValue_FontSize = 3;//
            system.Camera[0].UIParameter.Work_ImageDisplay_MaxValue_Location = new Point(141, 8);//
            system.Camera[0].UIParameter.Work_ImageDisplay_MaxValue_Size = new Size(32, 4);//
            system.Camera[0].UIParameter.Work_ImageDisplay_Lamp_Location = new Point(177, 3);//
            system.Camera[0].UIParameter.Work_ImageDisplay_Lamp_Size = new Size(9, 9);//
            system.Camera[0].UIParameter.Work_Name_FontSize = 9;//
            system.Camera[0].UIParameter.Work_Name_Location = new Point(585, 159);//
            system.Camera[0].UIParameter.Work_Name_Size = new Size(202, 17);//
            system.Camera[0].UIParameter.Work_State_FontSize = 9;//
            system.Camera[0].UIParameter.Work_State_Location = new Point(585, 176);//
            system.Camera[0].UIParameter.Work_State_Size = new Size(202, 17);//
            system.Camera[0].UIParameter.Work_SpeedPhase_Value_FontSize = 9;//
            system.Camera[0].UIParameter.Work_SpeedPhase_Value_Location = new Point(585, 193);//
            system.Camera[0].UIParameter.Work_SpeedPhase_Value_Size = new Size(101, 17);//
            system.Camera[0].UIParameter.Work_SpeedPhase_Unit_FontSize = 9;//
            system.Camera[0].UIParameter.Work_SpeedPhase_Unit_Location = new Point(686, 193);//
            system.Camera[0].UIParameter.Work_SpeedPhase_Unit_Size = new Size(101, 17);//
            //
            system.Camera[0].Live.CameraSelected = false;//相机显示控件是否被选中。true：是；false：否
            //
            system.Camera[0].DeviceInformation.Connected = true;//是否与客户端建立了连接。取值范围：true，是；false，否
            ...
            system.Camera[1].UIParameter.Work_Page = 0;//
            system.Camera[1].UIParameter.Work_LineStart_Location = new Point(330, 355);//
            system.Camera[1].UIParameter.Work_LineEnd_Location = new Point(270, 440);//
            system.Camera[1].UIParameter.Work_ImageDisplayBackground_Left = 5;//
            system.Camera[1].UIParameter.Work_ImageDisplayBackground_Top = 5;//
            system.Camera[1].UIParameter.Work_ImageDisplay_Location = new Point(70, 390);//
            system.Camera[1].UIParameter.Work_ImageDisplay_Size = new Size(192, 144);//
            system.Camera[1].UIParameter.Work_ImageDisplay_Message_FontSize = 3;//
            system.Camera[1].UIParameter.Work_ImageDisplay_Message_Location = new Point(3, 3);//
            system.Camera[1].UIParameter.Work_ImageDisplay_Message_Size = new Size(162, 6);//
            system.Camera[1].UIParameter.Work_ImageDisplay_Slot_Location = new Point(4, 9);//
            system.Camera[1].UIParameter.Work_ImageDisplay_Slot_Size = new Size(60, 3);//
            system.Camera[1].UIParameter.Work_ImageDisplay_MinValue_FontSize = 3;//
            system.Camera[1].UIParameter.Work_ImageDisplay_MinValue_Location = new Point(70, 8);//
            system.Camera[1].UIParameter.Work_ImageDisplay_MinValue_Size = new Size(32, 4);//
            system.Camera[1].UIParameter.Work_ImageDisplay_CurrentValue_FontSize = 3;//
            system.Camera[1].UIParameter.Work_ImageDisplay_CurrentValue_Location = new Point(106, 8);//
            system.Camera[1].UIParameter.Work_ImageDisplay_CurrentValue_Size = new Size(32, 4);//
            system.Camera[1].UIParameter.Work_ImageDisplay_MaxValue_FontSize = 3;//
            system.Camera[1].UIParameter.Work_ImageDisplay_MaxValue_Location = new Point(141, 8);//
            system.Camera[1].UIParameter.Work_ImageDisplay_MaxValue_Size = new Size(32, 4);//
            system.Camera[1].UIParameter.Work_ImageDisplay_Lamp_Location = new Point(177, 3);//
            system.Camera[1].UIParameter.Work_ImageDisplay_Lamp_Size = new Size(9, 9);//
            system.Camera[1].UIParameter.Work_Name_FontSize = 9;//
            system.Camera[1].UIParameter.Work_Name_Location = new Point(65, 539);//
            system.Camera[1].UIParameter.Work_Name_Size = new Size(202, 17);//
            system.Camera[1].UIParameter.Work_State_FontSize = 9;//
            system.Camera[1].UIParameter.Work_State_Location = new Point(65, 556);//
            system.Camera[1].UIParameter.Work_State_Size = new Size(202, 17);//
            system.Camera[1].UIParameter.Work_SpeedPhase_Value_FontSize = 9;//
            system.Camera[1].UIParameter.Work_SpeedPhase_Value_Location = new Point(65, 573);//
            system.Camera[1].UIParameter.Work_SpeedPhase_Value_Size = new Size(101, 17);//
            system.Camera[1].UIParameter.Work_SpeedPhase_Unit_FontSize = 9;//
            system.Camera[1].UIParameter.Work_SpeedPhase_Unit_Location = new Point(166, 573);//
            system.Camera[1].UIParameter.Work_SpeedPhase_Unit_Size = new Size(101, 17);//
            //
            system.Camera[1].Live.CameraSelected = false;//相机显示控件是否被选中。true：是；false：否
            //
            system.Camera[1].DeviceInformation.Connected = true;//是否与客户端建立了连接。取值范围：true，是；false，否
            ...
            system.Camera[2].Type = VisionSystemClassLibrary.Enum.CameraType.Camera_3;//相机类型
            system.Camera[2].Name = "Side";//相机名称
            //
            system.Camera[2].UIParameter.SpeedPhase_Display = false;//
            system.Camera[2].UIParameter.SpeedPhase_AsMachine = true;//

            system.Camera[2].UIParameter.Work_Page = 0;//
            system.Camera[2].UIParameter.Work_LineStart_Location = new Point(340, 255);//
            system.Camera[2].UIParameter.Work_LineEnd_Location = new Point(270, 60);//
            system.Camera[2].UIParameter.Work_ImageDisplayBackground_Left = 5;//
            system.Camera[2].UIParameter.Work_ImageDisplayBackground_Top = 5;//
            system.Camera[2].UIParameter.Work_ImageDisplay_Location = new Point(70, 10);//
            system.Camera[2].UIParameter.Work_ImageDisplay_Size = new Size(192, 144);//
            system.Camera[2].UIParameter.Work_ImageDisplay_Message_FontSize = 3;//
            system.Camera[2].UIParameter.Work_ImageDisplay_Message_Location = new Point(3, 3);//
            system.Camera[2].UIParameter.Work_ImageDisplay_Message_Size = new Size(162, 6);//
            system.Camera[2].UIParameter.Work_ImageDisplay_Slot_Location = new Point(4, 9);//
            system.Camera[2].UIParameter.Work_ImageDisplay_Slot_Size = new Size(60, 3);//
            system.Camera[2].UIParameter.Work_ImageDisplay_MinValue_FontSize = 3;//
            system.Camera[2].UIParameter.Work_ImageDisplay_MinValue_Location = new Point(70, 8);//
            system.Camera[2].UIParameter.Work_ImageDisplay_MinValue_Size = new Size(32, 4);//
            system.Camera[2].UIParameter.Work_ImageDisplay_CurrentValue_FontSize = 3;//
            system.Camera[2].UIParameter.Work_ImageDisplay_CurrentValue_Location = new Point(106, 8);//
            system.Camera[2].UIParameter.Work_ImageDisplay_CurrentValue_Size = new Size(32, 4);//
            system.Camera[2].UIParameter.Work_ImageDisplay_MaxValue_FontSize = 3;//
            system.Camera[2].UIParameter.Work_ImageDisplay_MaxValue_Location = new Point(141, 8);//
            system.Camera[2].UIParameter.Work_ImageDisplay_MaxValue_Size = new Size(32, 4);//
            system.Camera[2].UIParameter.Work_ImageDisplay_Lamp_Location = new Point(177, 3);//
            system.Camera[2].UIParameter.Work_ImageDisplay_Lamp_Size = new Size(9, 9);//
            system.Camera[2].UIParameter.Work_Name_FontSize = 9;//
            system.Camera[2].UIParameter.Work_Name_Location = new Point(65, 159);//
            system.Camera[2].UIParameter.Work_Name_Size = new Size(202, 17);//
            system.Camera[2].UIParameter.Work_State_FontSize = 9;//
            system.Camera[2].UIParameter.Work_State_Location = new Point(65, 176);//
            system.Camera[2].UIParameter.Work_State_Size = new Size(202, 17);//
            system.Camera[2].UIParameter.Work_SpeedPhase_Value_FontSize = 9;//
            system.Camera[2].UIParameter.Work_SpeedPhase_Value_Location = new Point(65, 193);//
            system.Camera[2].UIParameter.Work_SpeedPhase_Value_Size = new Size(101, 17);//
            system.Camera[2].UIParameter.Work_SpeedPhase_Unit_FontSize = 9;//
            system.Camera[2].UIParameter.Work_SpeedPhase_Unit_Location = new Point(166, 193);//
            system.Camera[2].UIParameter.Work_SpeedPhase_Unit_Size = new Size(101, 17);//
            //
            system.Camera[2].Live.CameraSelected = false;//相机显示控件是否被选中。true：是；false：否
            //
            system.Camera[2].DeviceInformation.Connected = true;//是否与客户端建立了连接。取值范围：true，是；false，否
            system.Camera[2].DeviceInformation.GetDevInfo = true;//是否存储了客户端的设备信息。取值范围：true，是；false，否
            system.Camera[2].DeviceInformation.CAM = VisionSystemClassLibrary.Enum.CameraState.CONNECTED | VisionSystemClassLibrary.Enum.CameraState.ON;//相机状态
            //↑↑
            //COMMON、G.DX6S，1024 * 768

            //FOCKE 700S，1024 * 768
            //↓↓
            system.Camera = new VisionSystemClassLibrary.Class.Camera[4];
            for (i = 0; i < system.Camera.Length; i++)
            {
                system.Camera[i] = new VisionSystemClassLibrary.Class.Camera();
            }
            ...
            system.UIParameter.Work_BackgroundImage_Zoom[0] = false;
            system.UIParameter.Work_BackgroundImage_Location[0] = new Point(255, 10);//
            system.UIParameter.Work_SpeedPhase_Value_Location = new Point(360, 540);//
            system.UIParameter.Work_SpeedPhase_Value_Size = new Size(60, 30);//
            system.UIParameter.Work_SpeedPhase_Value_FontSize = 12F;//
            system.UIParameter.Work_SpeedPhase_Unit_Location = new Point(420, 540);//
            system.UIParameter.Work_SpeedPhase_Unit_Size = new Size(60, 30);//
            system.UIParameter.Work_SpeedPhase_Unit_FontSize = 12F;//
            system.UIParameter.Work_TotalPage = 1;//
            system.Work.CurrentPage = 0;//
            ...
            system.Camera[0].Type = VisionSystemClassLibrary.Enum.CameraType.Camera_1;//相机类型
            system.Camera[0].Name = "Tobacco1";//相机名称
            //
            system.Camera[0].UIParameter.SpeedPhase_Display = false;//
            system.Camera[0].UIParameter.SpeedPhase_AsMachine = true;//

            system.Camera[0].UIParameter.Work_Page = 0;//
            system.Camera[0].UIParameter.Work_LineStart_Location = new Point(290, 120);//
            system.Camera[0].UIParameter.Work_LineEnd_Location = new Point(240, 120);//
            system.Camera[0].UIParameter.Work_ImageDisplayBackground_Left = 5;//
            system.Camera[0].UIParameter.Work_ImageDisplayBackground_Top = 5;//
            system.Camera[0].UIParameter.Work_ImageDisplay_Location = new Point(40, 50);//
            system.Camera[0].UIParameter.Work_ImageDisplay_Size = new Size(192, 144);//
            system.Camera[0].UIParameter.Work_ImageDisplay_Message_FontSize = 3;//
            system.Camera[0].UIParameter.Work_ImageDisplay_Message_Location = new Point(3, 3);//
            system.Camera[0].UIParameter.Work_ImageDisplay_Message_Size = new Size(162, 6);//
            ...
            system.Camera[0].UIParameter.Work_ImageDisplay_Lamp_Size = new Size(9, 9);//
            system.Camera[0].UIParameter.Work_Name_FontSize = 9;//
            system.Camera[0].UIParameter.Work_Name_Location = new Point(35, 199);//
            system.Camera[0].UIParameter.Work_Name_Size = new Size(202, 17);//
            system.Camera[0].UIParameter.Work_State_FontSize = 9;//
            system.Camera[0].UIParameter.Work_State_Location = new Point(35, 216);//
            system.Camera[0].UIParameter.Work_State_Size = new Size(202, 17);//
            system.Camera[0].UIParameter.Work_SpeedPhase_Value_FontSize = 9;//
            system.Camera[0].UIParameter.Work_SpeedPhase_Value_Location = new Point(35, 233);//
            system.Camera[0].UIParameter.Work_SpeedPhase_Value_Size = new Size(101, 17);//
            system.Camera[0].UIParameter.Work_SpeedPhase_Unit_FontSize = 9;//
            system.Camera[0].UIParameter.Work_SpeedPhase_Unit_Location = new Point(136, 233);//
            system.Camera[0].UIParameter.Work_SpeedPhase_Unit_Size = new Size(101, 17);//
            //
            system.Camera[0].Live.CameraSelected = false;//相机显示控件是否被选中。true：是；false：否
            //
            ...
            system.Camera[1].Type = VisionSystemClassLibrary.Enum.CameraType.Camera_2;//相机类型
            system.Camera[1].Name = "Tobacco2";//相机名称
            //
            system.Camera[1].UIParameter.SpeedPhase_Display = false;//
            system.Camera[1].UIParameter.SpeedPhase_AsMachine = true;//

            system.Camera[1].UIParameter.Work_Page = 0;//
            system.Camera[1].UIParameter.Work_LineStart_Location = new Point(290, 220);//
            system.Camera[1].UIParameter.Work_LineEnd_Location = new Point(240, 340);//
            system.Camera[1].UIParameter.Work_ImageDisplayBackground_Left = 5;//
            system.Camera[1].UIParameter.Work_ImageDisplayBackground_Top = 5;//
            system.Camera[1].UIParameter.Work_ImageDisplay_Location = new Point(40, 270);//
            system.Camera[1].UIParameter.Work_ImageDisplay_Size = new Size(192, 144);//
            system.Camera[1].UIParameter.Work_ImageDisplay_Message_FontSize = 3;//
            system.Camera[1].UIParameter.Work_ImageDisplay_Message_Location = new Point(3, 3);//
            system.Camera[1].UIParameter.Work_ImageDisplay_Message_Size = new Size(162, 6);//
            ...
            system.Camera[1].UIParameter.Work_ImageDisplay_Lamp_Size = new Size(9, 9);//
            system.Camera[1].UIParameter.Work_Name_FontSize = 9;//
            system.Camera[1].UIParameter.Work_Name_Location = new Point(35, 419);//
            system.Camera[1].UIParameter.Work_Name_Size = new Size(202, 17);//
            system.Camera[1].UIParameter.Work_State_FontSize = 9;//
            system.Camera[1].UIParameter.Work_State_Location = new Point(35, 436);//
            system.Camera[1].UIParameter.Work_State_Size = new Size(202, 17);//
            system.Camera[1].UIParameter.Work_SpeedPhase_Value_FontSize = 9;//
            system.Camera[1].UIParameter.Work_SpeedPhase_Value_Location = new Point(35, 453);//
            system.Camera[1].UIParameter.Work_SpeedPhase_Value_Size = new Size(101, 17);//
            system.Camera[1].UIParameter.Work_SpeedPhase_Unit_FontSize = 9;//
            system.Camera[1].UIParameter.Work_SpeedPhase_Unit_Location = new Point(136, 453);//
            system.Camera[1].UIParameter.Work_SpeedPhase_Unit_Size = new Size(101, 17);//
            //
            system.Camera[1].Live.CameraSelected = false;//相机显示控件是否被选中。true：是；false：否
            //
            ...
            system.Camera[2].Type = VisionSystemClassLibrary.Enum.CameraType.Camera_3;//相机类型
            system.Camera[2].Name = "Filter1";//相机名称
            //
            system.Camera[2].UIParameter.SpeedPhase_Display = false;//
            system.Camera[2].UIParameter.SpeedPhase_AsMachine = true;//

            system.Camera[2].UIParameter.Work_Page = 0;//
            system.Camera[2].UIParameter.Work_LineStart_Location = new Point(545, 340);//
            system.Camera[2].UIParameter.Work_LineEnd_Location = new Point(595, 190);//
            system.Camera[2].UIParameter.Work_ImageDisplayBackground_Left = 5;//
            system.Camera[2].UIParameter.Work_ImageDisplayBackground_Top = 5;//
            system.Camera[2].UIParameter.Work_ImageDisplay_Location = new Point(605, 130);//
            system.Camera[2].UIParameter.Work_ImageDisplay_Size = new Size(192, 144);//
            system.Camera[2].UIParameter.Work_ImageDisplay_Message_FontSize = 3;//
            system.Camera[2].UIParameter.Work_ImageDisplay_Message_Location = new Point(3, 3);//
            system.Camera[2].UIParameter.Work_ImageDisplay_Message_Size = new Size(162, 6);//
            ...
            system.Camera[2].UIParameter.Work_ImageDisplay_Lamp_Size = new Size(9, 9);//
            system.Camera[2].UIParameter.Work_Name_FontSize = 9;//
            system.Camera[2].UIParameter.Work_Name_Location = new Point(600, 279);//
            system.Camera[2].UIParameter.Work_Name_Size = new Size(202, 17);//
            system.Camera[2].UIParameter.Work_State_FontSize = 9;//
            system.Camera[2].UIParameter.Work_State_Location = new Point(600, 296);//
            system.Camera[2].UIParameter.Work_State_Size = new Size(202, 17);//
            system.Camera[2].UIParameter.Work_SpeedPhase_Value_FontSize = 9;//
            system.Camera[2].UIParameter.Work_SpeedPhase_Value_Location = new Point(600, 313);//
            system.Camera[2].UIParameter.Work_SpeedPhase_Value_Size = new Size(101, 17);//
            system.Camera[2].UIParameter.Work_SpeedPhase_Unit_FontSize = 9;//
            system.Camera[2].UIParameter.Work_SpeedPhase_Unit_Location = new Point(701, 313);//
            system.Camera[2].UIParameter.Work_SpeedPhase_Unit_Size = new Size(101, 17);//
            //
            system.Camera[2].Live.CameraSelected = false;//相机显示控件是否被选中。true：是；false：否
            //
            ...
            system.Camera[3].Type = VisionSystemClassLibrary.Enum.CameraType.Camera_4;//相机类型
            system.Camera[3].Name = "Filter2";//相机名称
            //
            system.Camera[3].UIParameter.SpeedPhase_Display = false;//
            system.Camera[3].UIParameter.SpeedPhase_AsMachine = true;//

            system.Camera[3].UIParameter.Work_Page = 0;//
            system.Camera[3].UIParameter.Work_LineStart_Location = new Point(545, 430);//
            system.Camera[3].UIParameter.Work_LineEnd_Location = new Point(595, 430);//
            system.Camera[3].UIParameter.Work_ImageDisplayBackground_Left = 5;//
            system.Camera[3].UIParameter.Work_ImageDisplayBackground_Top = 5;//
            system.Camera[3].UIParameter.Work_ImageDisplay_Location = new Point(605, 360);//
            system.Camera[3].UIParameter.Work_ImageDisplay_Size = new Size(192, 144);//
            system.Camera[3].UIParameter.Work_ImageDisplay_Message_FontSize = 3;//
            system.Camera[3].UIParameter.Work_ImageDisplay_Message_Location = new Point(3, 3);//
            system.Camera[3].UIParameter.Work_ImageDisplay_Message_Size = new Size(162, 6);//
            system.Camera[3].UIParameter.Work_ImageDisplay_Slot_Location = new Point(4, 9);//
            system.Camera[3].UIParameter.Work_ImageDisplay_Slot_Size = new Size(60, 3);//
            system.Camera[3].UIParameter.Work_ImageDisplay_MinValue_FontSize = 3;//
            system.Camera[3].UIParameter.Work_ImageDisplay_MinValue_Location = new Point(70, 8);//
            system.Camera[3].UIParameter.Work_ImageDisplay_MinValue_Size = new Size(32, 4);//
            system.Camera[3].UIParameter.Work_ImageDisplay_CurrentValue_FontSize = 3;//
            system.Camera[3].UIParameter.Work_ImageDisplay_CurrentValue_Location = new Point(106, 8);//
            system.Camera[3].UIParameter.Work_ImageDisplay_CurrentValue_Size = new Size(32, 4);//
            system.Camera[3].UIParameter.Work_ImageDisplay_MaxValue_FontSize = 3;//
            system.Camera[3].UIParameter.Work_ImageDisplay_MaxValue_Location = new Point(141, 8);//
            system.Camera[3].UIParameter.Work_ImageDisplay_MaxValue_Size = new Size(32, 4);//
            system.Camera[3].UIParameter.Work_ImageDisplay_Lamp_Location = new Point(177, 3);//
            system.Camera[3].UIParameter.Work_ImageDisplay_Lamp_Size = new Size(9, 9);//
            system.Camera[3].UIParameter.Work_Name_FontSize = 9;//
            system.Camera[3].UIParameter.Work_Name_Location = new Point(600, 509);//
            system.Camera[3].UIParameter.Work_Name_Size = new Size(202, 17);//
            system.Camera[3].UIParameter.Work_State_FontSize = 9;//
            system.Camera[3].UIParameter.Work_State_Location = new Point(600, 526);//
            system.Camera[3].UIParameter.Work_State_Size = new Size(202, 17);//
            system.Camera[3].UIParameter.Work_SpeedPhase_Value_FontSize = 9;//
            system.Camera[3].UIParameter.Work_SpeedPhase_Value_Location = new Point(600, 543);//
            system.Camera[3].UIParameter.Work_SpeedPhase_Value_Size = new Size(101, 17);//
            system.Camera[3].UIParameter.Work_SpeedPhase_Unit_FontSize = 9;//
            system.Camera[3].UIParameter.Work_SpeedPhase_Unit_Location = new Point(701, 60);//
            system.Camera[3].UIParameter.Work_SpeedPhase_Unit_Size = new Size(101, 17);//
            //
            system.Camera[3].Live.CameraSelected = false;//相机显示控件是否被选中。true：是；false：否
            //
            system.Camera[3].DeviceInformation.Connected = true;//是否与客户端建立了连接。取值范围：true，是；false，否
            system.Camera[3].DeviceInformation.GetDevInfo = true;//是否存储了客户端的设备信息。取值范围：true，是；false，否
            system.Camera[3].DeviceInformation.CAM = VisionSystemClassLibrary.Enum.CameraState.CONNECTED | VisionSystemClassLibrary.Enum.CameraState.ON;//相机状态
            //↑↑
            //FOCKE 700S，1024 * 768
            ...
            system.UIParameter.Work_BackgroundImage_Zoom[0] = false;
            system.UIParameter.Work_BackgroundImage_Location[0] = new Point(20, 40);//
            system.UIParameter.Work_SpeedPhase_Value_Location = new Point(135, 490);//
            system.UIParameter.Work_SpeedPhase_Value_Size = new Size(115, 25);//
            system.UIParameter.Work_SpeedPhase_Value_FontSize = 12F;//
            system.UIParameter.Work_SpeedPhase_Unit_Location = new Point(250, 490);//
            system.UIParameter.Work_SpeedPhase_Unit_Size = new Size(115, 25);//
            system.UIParameter.Work_SpeedPhase_Unit_FontSize = 12F;//
            system.UIParameter.Work_TotalPage = 1;//
            system.Work.CurrentPage = 0;//
            system.Work.SelectedCameraType = VisionSystemClassLibrary.Enum.CameraType.None;//
            ...
            system.Camera[0].Type = VisionSystemClassLibrary.Enum.CameraType.Camera_1;//相机类型
            system.Camera[0].Name = "Filter";//相机名称
            //
            system.Camera[0].UIParameter.SpeedPhase_Display = true;//
            system.Camera[0].UIParameter.SpeedPhase_AsMachine = true;//

            system.Camera[0].UIParameter.Work_Page = 0;//
            system.Camera[0].UIParameter.Work_LineStart_Location = new Point(325, 205);//
            system.Camera[0].UIParameter.Work_LineEnd_Location = new Point(350, 370);//
            system.Camera[0].UIParameter.Work_ImageDisplayBackground_Left = 5;//
            system.Camera[0].UIParameter.Work_ImageDisplayBackground_Top = 5;//
            system.Camera[0].UIParameter.Work_ImageDisplay_Location = new Point(20, 10);//
            system.Camera[0].UIParameter.Work_ImageDisplay_Size = new Size(297, 192);//
            system.Camera[0].UIParameter.Work_ImageDisplay_Message_FontSize = 6;//
            system.Camera[0].UIParameter.Work_ImageDisplay_Message_Location = new Point(4, 3);//
            system.Camera[0].UIParameter.Work_ImageDisplay_Message_Size = new Size(250, 9);//
            system.Camera[0].UIParameter.Work_ImageDisplay_Slot_Location = new Point(6, 13);//
            system.Camera[0].UIParameter.Work_ImageDisplay_Slot_Size = new Size(96, 4);//
            system.Camera[0].UIParameter.Work_ImageDisplay_MinValue_FontSize = 5;//
            system.Camera[0].UIParameter.Work_ImageDisplay_MinValue_Location = new Point(108, 11);//
            system.Camera[0].UIParameter.Work_ImageDisplay_MinValue_Size = new Size(55, 6);//
            system.Camera[0].UIParameter.Work_ImageDisplay_CurrentValue_FontSize = 5;//
            system.Camera[0].UIParameter.Work_ImageDisplay_CurrentValue_Location = new Point(164, 11);//
            system.Camera[0].UIParameter.Work_ImageDisplay_CurrentValue_Size = new Size(55, 6);//
            system.Camera[0].UIParameter.Work_ImageDisplay_MaxValue_FontSize = 5;//
            system.Camera[0].UIParameter.Work_ImageDisplay_MaxValue_Location = new Point(219, 11);//
            system.Camera[0].UIParameter.Work_ImageDisplay_MaxValue_Size = new Size(55, 6);//
            system.Camera[0].UIParameter.Work_ImageDisplay_Lamp_Location = new Point(273, 4);//
            system.Camera[0].UIParameter.Work_ImageDisplay_Lamp_Size = new Size(14, 12);//
            system.Camera[0].UIParameter.Work_Name_FontSize = 12;//
            system.Camera[0].UIParameter.Work_Name_Location = new Point(15, 207);//
            system.Camera[0].UIParameter.Work_Name_Size = new Size(307, 25);//
            system.Camera[0].UIParameter.Work_State_FontSize = 12;//
            system.Camera[0].UIParameter.Work_State_Location = new Point(15, 232);//
            system.Camera[0].UIParameter.Work_State_Size = new Size(307, 25);//
            system.Camera[0].UIParameter.Work_SpeedPhase_Value_FontSize = 12;//
            system.Camera[0].UIParameter.Work_SpeedPhase_Value_Location = new Point(15, 257);//
            system.Camera[0].UIParameter.Work_SpeedPhase_Value_Size = new Size(153, 25);//
            system.Camera[0].UIParameter.Work_SpeedPhase_Unit_FontSize = 12;//
            system.Camera[0].UIParameter.Work_SpeedPhase_Unit_Location = new Point(168, 257);//
            system.Camera[0].UIParameter.Work_SpeedPhase_Unit_Size = new Size(154, 25);//
            //
            system.Camera[0].Live.CameraSelected = false;//相机显示控件是否被选中。true：是；false：否
            //
            system.Camera[0].DeviceInformation.Connected = true;//是否与客户端建立了连接。取值范围：true，是；false，否
            ...
            system.Camera[1].Type = VisionSystemClassLibrary.Enum.CameraType.Camera_2;//相机类型
            system.Camera[1].Name = "Tobacco";//相机名称
            //
            system.Camera[1].UIParameter.SpeedPhase_Display = true;//
            system.Camera[1].UIParameter.SpeedPhase_AsMachine = false;//

            system.Camera[1].UIParameter.Work_Page = 0;//
            system.Camera[1].UIParameter.Work_LineStart_Location = new Point(670, 320);//
            system.Camera[1].UIParameter.Work_LineEnd_Location = new Point(745, 120);//
            system.Camera[1].UIParameter.Work_ImageDisplayBackground_Left = 5;//
            system.Camera[1].UIParameter.Work_ImageDisplayBackground_Top = 5;//
            system.Camera[1].UIParameter.Work_ImageDisplay_Location = new Point(525, 340);//
            system.Camera[1].UIParameter.Work_ImageDisplay_Size = new Size(297, 192);//
            system.Camera[1].UIParameter.Work_ImageDisplay_Message_FontSize = 6;//
            system.Camera[1].UIParameter.Work_ImageDisplay_Message_Location = new Point(4, 3);//
            system.Camera[1].UIParameter.Work_ImageDisplay_Message_Size = new Size(250, 9);//
            system.Camera[1].UIParameter.Work_ImageDisplay_Slot_Location = new Point(6, 13);//
            system.Camera[1].UIParameter.Work_ImageDisplay_Slot_Size = new Size(96, 4);//
            system.Camera[1].UIParameter.Work_ImageDisplay_MinValue_FontSize = 5;//
            system.Camera[1].UIParameter.Work_ImageDisplay_MinValue_Location = new Point(108, 11);//
            system.Camera[1].UIParameter.Work_ImageDisplay_MinValue_Size = new Size(55, 6);//
            system.Camera[1].UIParameter.Work_ImageDisplay_CurrentValue_FontSize = 5;//
            system.Camera[1].UIParameter.Work_ImageDisplay_CurrentValue_Location = new Point(164, 11);//
            system.Camera[1].UIParameter.Work_ImageDisplay_CurrentValue_Size = new Size(55, 6);//
            system.Camera[1].UIParameter.Work_ImageDisplay_MaxValue_FontSize = 5;//
            system.Camera[1].UIParameter.Work_ImageDisplay_MaxValue_Location = new Point(219, 11);//
            system.Camera[1].UIParameter.Work_ImageDisplay_MaxValue_Size = new Size(55, 6);//
            system.Camera[1].UIParameter.Work_ImageDisplay_Lamp_Location = new Point(273, 4);//
            system.Camera[1].UIParameter.Work_ImageDisplay_Lamp_Size = new Size(14, 12);//
            system.Camera[1].UIParameter.Work_Name_FontSize = 12;//
            system.Camera[1].UIParameter.Work_Name_Location = new Point(520, 537);//
            system.Camera[1].UIParameter.Work_Name_Size = new Size(307, 25);//
            system.Camera[1].UIParameter.Work_State_FontSize = 12;//
            system.Camera[1].UIParameter.Work_State_Location = new Point(520, 562);//
            system.Camera[1].UIParameter.Work_State_Size = new Size(307, 25);//
            system.Camera[1].UIParameter.Work_SpeedPhase_Value_FontSize = 12;//
            system.Camera[1].UIParameter.Work_SpeedPhase_Value_Location = new Point(520, 587);//
            system.Camera[1].UIParameter.Work_SpeedPhase_Value_Size = new Size(153, 25);//
            system.Camera[1].UIParameter.Work_SpeedPhase_Unit_FontSize = 12;//
            system.Camera[1].UIParameter.Work_SpeedPhase_Unit_Location = new Point(673, 587);//
            system.Camera[1].UIParameter.Work_SpeedPhase_Unit_Size = new Size(154, 25);//
            //
            system.Camera[1].Live.CameraSelected = false;//相机显示控件是否被选中。true：是；false：否
            //
            system.Camera[1].DeviceInformation.Connected = true;//是否与客户端建立了连接。取值范围：true，是；false，否
