...
namespace VisionSystemControlLibrary
{
    ...
    public partial class SizeAdjustedPanel : UserControl
    {
        ...
        private Rectangle rectangleROI;//属性，操作的兴趣区域
        ...
        {
            Rectangle rectangleROI_Temp = rectangleROI;

            switch (contentalignmentHandleType)
            {
                case ContentAlignment.TopLeft://点击手柄上左按钮
                    //
                    rectangleROI_Temp.Width++;
                    rectangleROI_Temp.Height++;
                    rectangleROI_Temp.X--;
                    rectangleROI_Temp.Y--;

                    break;
                    //
                case ContentAlignment.BottomRight://点击手柄下右按钮
                    //
                    rectangleROI_Temp.Width--;
                    rectangleROI_Temp.Height--;
            ...
            if (rectangleMaxROI.Contains(rectangleROI_Temp))//有效
            {
                rectangleROI = rectangleROI_Temp;
        ...
        private void _CustomButtonTop_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            switch (contentalignmentHandleType)
            {
                case ContentAlignment.TopCenter://点击手柄上中按钮
                    //
                    rectangleROI_Temp.Height++;
                    rectangleROI_Temp.Y--;
                    ...
                    break;
                    //
                case ContentAlignment.BottomCenter://点击手柄下中按钮
                    //
                    rectangleROI_Temp.Height--;
        ...
        private void _CustomButtonRightTop_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            switch (contentalignmentHandleType)
            {
                case ContentAlignment.TopRight://点击手柄上右按钮
                    //
                    rectangleROI_Temp.Width++;
                    rectangleROI_Temp.Height++;
                    rectangleROI_Temp.Y--;
                    ...
                    break;
                    //
                case ContentAlignment.BottomLeft://点击手柄下左按钮
                    //
                    rectangleROI_Temp.Width--;
                    rectangleROI_Temp.Height--;
                    rectangleROI_Temp.X++;
        ...
        private void _CustomButtonLeft_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            switch (contentalignmentHandleType)
            {
                case ContentAlignment.MiddleLeft://点击手柄中左按钮
                    //
                    rectangleROI_Temp.Width++;
                    rectangleROI_Temp.X--;
                    ...
                    break;
                    //
                case ContentAlignment.MiddleRight://点击手柄中右按钮
                    //
                    rectangleROI_Temp.Width--;
