...
namespace VisionSystemUserInterface
{
    public partial class Template : Form
    {
        ...
        private void Template_Load(object sender, EventArgs e)
        {
            ...
            TitleBar.AdministratorPassword = "VISION";//管理员密码
            ...
            {
                TitleBar.FaultExist = new Boolean[Global.VisionSystem.Camera.Count];
                TitleBar.CameraName_Chinese = new String[Global.VisionSystem.Camera.Count];
                TitleBar.CameraName_English = new String[Global.VisionSystem.Camera.Count];
