    ...
    public partial class QualityCheck : Template
    {
        ...
        private void qualityCheckControl_Close_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Global.VisionSystem.Camera[Global.VisionSystem.Work.SelectedCameraIndex].DeviceInformation._CopyTo(ref devicedata);
                
                Global.VisionSystem.Camera[Global.VisionSystem.Work.SelectedCameraIndex] = qualityCheckControl.SelectedCamera;
                devicedata._CopyTo(ref Global.VisionSystem.Camera[Global.VisionSystem.Work.SelectedCameraIndex].DeviceInformation);
            }
            catch (System.Exception ex)
            {
            	//不执行操作
        ...
        private void qualityCheckControl_ToolChanged(object sender, EventArgs e)
        {
            ...
            {
                Global.WorkWindow._SendCommand_Value(CommunicationInstructionType.QualityCheck_CurrentTool, Global.VisionSystem.Work.SelectedCameraType, Global.VisionSystem.Work.SelectedCameraIndex, qualityCheckControl.CurrentToolIndex, 3, qualityCheckControl.RejectImageIndex);//发送指令
            }
            else//LIVE VIEW
            {
        ...
        private void qualityCheckControl_ToolParameterValueChanged(object sender, EventArgs e)
        {
            ...
            {
                Global.WorkWindow._SendCommand_Value(CommunicationInstructionType.QualityCheck_ToolParamter, Global.VisionSystem.Work.SelectedCameraType, Global.VisionSystem.Work.SelectedCameraIndex, qualityCheckControl.CurrentToolIndex, 3, qualityCheckControl.RejectImageIndex);//发送指令
            }
            else//LIVE VIEW
            {
        ...
        private void qualityCheckControl_ToolRegionChanged(object sender, EventArgs e)
        {
            ...
            if (qualityCheckControl.LoadSampleSelected)//【LOAD SAMPLE】按下
            {
                Global.WorkWindow._SendCommand_Value(CommunicationInstructionType.QualityCheck_WorkArea, Global.VisionSystem.Work.SelectedCameraType, Global.VisionSystem.Work.SelectedCameraIndex, qualityCheckControl.CurrentToolIndex, 2, 0, Global.VisionSystem.Camera[Global.VisionSystem.Work.SelectedCameraIndex].Tools[qualityCheckControl.CurrentToolIndex].WorkAreaPointX, Global.VisionSystem.Camera[Global.VisionSystem.Work.SelectedCameraIndex].Tools[qualityCheckControl.CurrentToolIndex].WorkAreaPointY, Global.VisionSystem.Camera[Global.VisionSystem.Work.SelectedCameraIndex].Tools[qualityCheckControl.CurrentToolIndex].WorkAreaWidth, Global.VisionSystem.Camera[Global.VisionSystem.Work.SelectedCameraIndex].Tools[qualityCheckControl.CurrentToolIndex].WorkAreaHeight);//发送指令
            }
            else if (qualityCheckControl.LoadRejectSelected)//【LOAD REJECT】按下
            {
                Global.WorkWindow._SendCommand_Value(CommunicationInstructionType.QualityCheck_WorkArea, Global.VisionSystem.Work.SelectedCameraType, Global.VisionSystem.Work.SelectedCameraIndex, qualityCheckControl.CurrentToolIndex, 3, qualityCheckControl.RejectImageIndex, Global.VisionSystem.Camera[Global.VisionSystem.Work.SelectedCameraIndex].Tools[qualityCheckControl.CurrentToolIndex].WorkAreaPointX, Global.VisionSystem.Camera[Global.VisionSystem.Work.SelectedCameraIndex].Tools[qualityCheckControl.CurrentToolIndex].WorkAreaPointY, Global.VisionSystem.Camera[Global.VisionSystem.Work.SelectedCameraIndex].Tools[qualityCheckControl.CurrentToolIndex].WorkAreaWidth, Global.VisionSystem.Camera[Global.VisionSystem.Work.SelectedCameraIndex].Tools[qualityCheckControl.CurrentToolIndex].WorkAreaHeight);//发送指令
            }
            else//LIVE VIEW
            {
                Global.WorkWindow._SendCommand_Value(CommunicationInstructionType.QualityCheck_WorkArea, Global.VisionSystem.Work.SelectedCameraType, Global.VisionSystem.Work.SelectedCameraIndex, qualityCheckControl.CurrentToolIndex, 1, 0, Global.VisionSystem.Camera[Global.VisionSystem.Work.SelectedCameraIndex].Tools[qualityCheckControl.CurrentToolIndex].WorkAreaPointX, Global.VisionSystem.Camera[Global.VisionSystem.Work.SelectedCameraIndex].Tools[qualityCheckControl.CurrentToolIndex].WorkAreaPointY, Global.VisionSystem.Camera[Global.VisionSystem.Work.SelectedCameraIndex].Tools[qualityCheckControl.CurrentToolIndex].WorkAreaWidth, Global.VisionSystem.Camera[Global.VisionSystem.Work.SelectedCameraIndex].Tools[qualityCheckControl.CurrentToolIndex].WorkAreaHeight);//发送指令
            }
        }
        ...
        private void qualityCheckControl_LearnSample_Click(object sender, EventArgs e)
        {
            ...
            if (qualityCheckControl.LoadSampleSelected)//【LOAD SAMPLE】按下
            {
                Global.WorkWindow._SendCommand_Image_Learn(CommunicationInstructionType.QualityCheck_LearnSample, Global.VisionSystem.Work.SelectedCameraType, Global.VisionSystem.Work.SelectedCameraIndex, 1.0, qualityCheckControl.CurrentToolIndex, 2);//发送指令
            }
            else if (qualityCheckControl.LoadRejectSelected)//【LOAD REJECT】按下
            {
                Global.WorkWindow._SendCommand_Image_Learn(CommunicationInstructionType.QualityCheck_LearnSample, Global.VisionSystem.Work.SelectedCameraType, Global.VisionSystem.Work.SelectedCameraIndex, 1.0, qualityCheckControl.CurrentToolIndex, 3, qualityCheckControl.RejectImageIndex);//发送指令
            }
            else//LIVE VIEW
            {
                Global.WorkWindow._SendCommand_Image_Learn(CommunicationInstructionType.QualityCheck_LearnSample, Global.VisionSystem.Work.SelectedCameraType, Global.VisionSystem.Work.SelectedCameraIndex, 1.0, qualityCheckControl.CurrentToolIndex, 1);//发送指令
            }
        }
        ...
        private void qualityCheckControl_LoadSample_Click(object sender, EventArgs e)
        {
            if (qualityCheckControl.LoadSampleSelected)//【LOAD SAMPLE】按下
            {
                ...
                Global.WorkWindow._SendCommand_Image(CommunicationInstructionType.QualityCheck_LoadSample, Global.VisionSystem.Work.SelectedCameraType, Global.VisionSystem.Work.SelectedCameraIndex, 1.0, qualityCheckControl.CurrentToolIndex);//发送指令
        ...
        private void qualityCheckControl_ManageTools_Click(object sender, EventArgs e)
        {
            ...
            {
                Global.WorkWindow._SendCommand_Value(CommunicationInstructionType.QualityCheck_ManageTools, Global.VisionSystem.Work.SelectedCameraType, Global.VisionSystem.Work.SelectedCameraIndex, qualityCheckControl.CurrentToolIndex, 3, qualityCheckControl.RejectImageIndex);//发送指令
            }
            else//LIVE VIEW
            {
        ...
        private void qualityCheckControl_LoadReject_Click(object sender, EventArgs e)
        {
            if (qualityCheckControl.LoadRejectSelected)//【LOAD REJECT】按下
            {
                ...
                Global.WorkWindow._SendCommand_Image(CommunicationInstructionType.QualityCheck_LoadReject_Update, Global.VisionSystem.Work.SelectedCameraType, Global.VisionSystem.Work.SelectedCameraIndex);//发送指令
            }
            else//【LOAD REJECT】弹起
            {
                //显示LIVE图像
        ...
        private void qualityCheckControl_LoadReject_ImageSelect_Click(object sender, EventArgs e)
        {
            ...
            Global.WorkWindow._SendCommand_Image(CommunicationInstructionType.QualityCheck_LoadReject_Click, Global.VisionSystem.Work.SelectedCameraType, Global.VisionSystem.Work.SelectedCameraIndex);//发送指令
        }
    }
}