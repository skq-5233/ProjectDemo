    ...
    public partial class ImageConfiguration : Template
    {
        ...
        private void imageConfigurationControl_Close_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Global.VisionSystem.Camera[Global.WorkWindow._GetSelectedCameraIndex(Global.DevicesSetupWindow.CustomControl.CameraSelected)].DeviceInformation._CopyTo(ref devicedata);
                ...
                devicedata._CopyTo(ref Global.VisionSystem.Camera[Global.WorkWindow._GetSelectedCameraIndex(Global.DevicesSetupWindow.CustomControl.CameraSelected)].DeviceInformation);
