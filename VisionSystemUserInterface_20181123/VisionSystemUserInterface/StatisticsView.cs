    ...
    public partial class StatisticsView : Template
    {
        ...
        public void _SetWindow()
        {
            ...
            try
            {
                ...
                statisticsControl._Properties(Global.VisionSystem.Camera[Global.VisionSystem.Work.SelectedCameraIndex], Global.VisionSystem.Shift);//应用属性
            }
            ...
            Global.WorkWindow._SendCommand_Value(CommunicationInstructionType.Statistics_GetSelectedRecordData, Global.VisionSystem.Work.SelectedCameraType, Global.VisionSystem.Work.SelectedCameraIndex, 0, 0 + 1, new VisionSystemClassLibrary.Struct.ShiftTime());//发送指令
        }
        ...
        private void statisticsControl_GetRecordData(object sender, EventArgs e)
        {
            ...
            //{
                ...
                Global.WorkWindow._SendCommand_Value(CommunicationInstructionType.Statistics_GetSelectedRecordData, Global.VisionSystem.Work.SelectedCameraType, Global.VisionSystem.Work.SelectedCameraIndex, 1, VisionSystemControlLibrary.GlobalWindows.StatisticsRecord_Window.StatisticsRecordControl.SelectedShiftIndex + 1, VisionSystemControlLibrary.GlobalWindows.StatisticsRecord_Window.StatisticsRecordControl.ShiftTimeSelectedRecordTemp);//发送指令
            //}
        }
    }
}